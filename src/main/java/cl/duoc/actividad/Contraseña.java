...
public class Contraseña extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textoo.setForeground(new java.awt.Color(255, 0, 0));
        textoo.setText(" ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(textoo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        String nombre = user.getText().toLowerCase();
        String contraseña = password.getText();
        if(nombre.equals("admin") && contraseña.equals("123")){
            
            Centro newFrame = new Centro();
            newFrame.setVisible(true);
            this.dispose();
            
        }else{
            textoo.setText("Contraseña o usuario invalido");
            }
